...
local Module = LibStub("AceAddon-3.0"):GetAddon("Sora"):NewModule("ActionBar", "AceEvent-3.0")
...
function Module:UpdateBar1()
	...
	bar:SetPoint("BOTTOM", ActionBar, "BOTTOM")
	local Page = {
...
function Module:UpdateBar2()
	...
	bar:SetWidth(C["ButtonSize"]*12+C["ButtonSpacing"]*11)
	bar:SetHeight(C["ButtonSize"])
	bar:SetPoint("BOTTOM", SunUIActionBar1, "TOP", 0, C["ButtonSpacing"])
...
function Module:UpdateBar3()
	...
	bar:SetWidth(C["ButtonSize"]*12+C["ButtonSpacing"]*11)
	bar:SetHeight(C["ButtonSize"])
	bar:SetPoint("BOTTOM", SunUIActionBar2, "TOP", 0, C["ButtonSpacing"])
		for i=1, 12 do
	...
	bar:SetHeight(C["ButtonSize"])
	bar:SetPoint("BOTTOMRIGHT", "SunUIActionBar1", "BOTTOMLEFT", -C["ButtonSpacing"], 0)
	bar2:SetWidth(C["ButtonSize"]*6+C["ButtonSpacing"]*5)
	bar2:SetHeight(C["ButtonSize"])
	bar2:SetPoint("BOTTOMLEFT", "SunUIActionBar1", "BOTTOMRIGHT", C["ButtonSpacing"], 0)
	for i = 1, 12 do
...
function Module:UpdateBar4()
	local bar = CreateFrame("Frame","SunUIActionBar4",UIParent, "SecureHandlerStateTemplate")
	 if C["Bar4Layout"] == 2 then
		...
		bar:SetHitRectInsets(-10, -10, -10, -10)
	MoveHandle.SunUIActionBar4 = S.MakeMoveHandle(bar, "SunUIActionBar4", "bar4")
...
function Module:UpdateBar5()
		...
		MoveHandle.SunUIActionBar5 = S.MakeMoveHandle(bar, "SunUIActionBar5", "bar5")
		bar:SetHitRectInsets(-10, -10, -10, -10)
...
function Module:UpdatePetBar()
    ...
    bar:SetHeight(C["ButtonSize"])
    bar:SetHitRectInsets(-10, -10, -10, -10)
	bar:SetPoint("TOPRIGHT",ActionBar,"TOPRIGHT")
...
function Module:UpdateStanceBar()
    ...
    bar:SetHeight(C["ButtonSize"])
    bar:SetHitRectInsets(-10, -10, -10, -10)
	bar:SetPoint("TOPLEFT",ActionBar,"TOPLEFT")
...
function Module:UpdateTotemBar()
    ...
    MoveHandle.SunUITotemBar = S.MakeMoveHandle(bar, "SunUI图腾栏", "totembar")
	bar:SetHitRectInsets(-10, -10, -10, -10)
...
function  Module:BuildActionBar()
	C = ActionBarDB
	local mainbar = CreateFrame("Frame","ActionBar",UIParent, "SecureHandlerStateTemplate")
	if C["BarLayout"] == 2 then
		mainbar:SetHeight(3*C["ButtonSize"]+2*C["ButtonSpacing"])
		mainbar:SetWidth(18*C["ButtonSize"]+17*C["ButtonSpacing"])
	else
		mainbar:SetHeight(4*C["ButtonSize"]+3*C["ButtonSpacing"])
		mainbar:SetWidth(12*C["ButtonSize"]+11*C["ButtonSpacing"])
	end
	MoveHandle.mainbar = S.MakeMoveHandle(mainbar, "ActionBar", "ActionBar")
	Module:UpdateBar1()
	Module:UpdateBar2()
	Module:UpdateBar3()
	Module:UpdateBar4()
